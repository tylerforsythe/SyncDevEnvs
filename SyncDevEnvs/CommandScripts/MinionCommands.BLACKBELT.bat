...
"C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLCMD.EXE" -S BLACKBELT -d master -Q "ALTER DATABASE IMPrintingLucy SET SINGLE_USER WITH ROLLBACK AFTER 3"

"C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLCMD.EXE" -S BLACKBELT -d master -Q "RESTORE DATABASE IMPrintingLucy FROM DISK = '{TEMP_DIR_PATH}\IMPrinting_{FILE_TIMESTAMP}.BAK' WITH REPLACE"

"C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLCMD.EXE" -S BLACKBELT -d master -Q "ALTER DATABASE IMPrintingLucy SET MULTI_USER"
...
REM del /Q "{TEMP_DIR_PATH}\IMPrinting_{FILE_TIMESTAMP}.BAK"
