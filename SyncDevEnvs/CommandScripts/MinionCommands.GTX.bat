...
"C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLCMD.EXE" -S GTX -d master -Q "RESTORE DATABASE IMPrintingLucy FROM DISK = '{TEMP_DIR_PATH}\IMPrinting_{FILE_TIMESTAMP}.BAK' WITH REPLACE"
